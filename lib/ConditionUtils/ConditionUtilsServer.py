...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ConditionUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ConditionUtils.ConditionUtilsImpl import ConditionUtils  # noqa @IgnorePep8
impl_ConditionUtils = ConditionUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_ConditionUtils.export_cluster_set_excel,
                             name='ConditionUtils.export_cluster_set_excel',
                             types=[dict])
        self.method_authentication['ConditionUtils.export_cluster_set_excel'] = 'required'  # noqa
